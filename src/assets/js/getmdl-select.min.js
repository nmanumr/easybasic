...
window.onload = function() {
    getmdlSelect.init(".getmdl-select"), document.addEventListener("DOMNodeInserted", function(e) {
        e.relatedNode.querySelectorAll(".getmdl-select")
            .length > 0 && componentHandler.upgradeDom()
    }, !1)
};
var getmdlSelect = {
    addEventListeners: function(e) {
        ...
        t.onkeydown = function(e) {
            ...
            n.onclick = function() {
                if (t.value = n.textContent, e.MaterialTextfield.change(n.textContent), setTimeout(function() {
                    ...
                    l.initEvent("change", !1, !0), t.dispatchEvent(l)
    ...
    init: function(e) {
        ...
        [].forEach.call(t, function(e) {
            ...
            if(e.querySelector(".getmdl-select"))
                e.style.width = e.querySelector(".getmdl-select").clientWidth + "px";
        })
    }
};
